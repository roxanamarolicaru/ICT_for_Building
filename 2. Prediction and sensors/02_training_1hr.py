...
plt.title("Learning curve for 1 hr",fontsize=13)
...
plt.title("Prediction for operative temperatures of Zone "+str(feature+1)+" for 1 hr",fontsize=13)
...
plt.title("Error probability density for 1 hr",fontsize=13)
plt.grid(linestyle='--')
...
plt.title("Prediction of Energy consumption Q for 1 hr",fontsize=13)
#plt.plot(np.array(temps.iloc[train_size+epoch_init:train_size+epoch_init+N,feature]), label='Actual value')
plt.plot(test_Y[epoch_init:epoch_init+N,feature], label='Real future value')
plt.plot(testPredict[epoch_init:epoch_init+N,feature], label='Predicted future value')
plt.grid(linestyle='--')
